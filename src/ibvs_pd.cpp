...
int main(int argc, char *argv[])
{
    ...
    Eigen::Vector4d Pert;
    Pert << Delta(0), Delta(1), Delta(2), 0;
    ...
    ros::Duration(1.0).sleep();
        ...
        while (ros::ok())
        {
            ...
            //PD controller
            pd = eta_1 * Error_d + eta_2 * Error + PHI + Pert;
            ...
            xi_d = Xi_dot(Lambda_estimate, Lambda_estimate_dot, eta_1, eta_2, r1, r2, r3, pd, Gamma, PI, RHO, xi);
            ...
            //-----------------------------Update Law--------------------------------------------------
            //******************************************************************************************
            Upsi_est_d = Upsilon_estimate_dot(gamma, xi, xi_d, I, eta_1, eta_2, Gamma, pd);
